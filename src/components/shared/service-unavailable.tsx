  ...
  return (
    <div className="flex min-h-[420px] items-center justify-center px-6 py-12">
      <section role="alert" aria-live="polite" className="w-full max-w-lg rounded-xl border border-warning/30 bg-panel-bg/60 p-8 text-center shadow-sm">
        ...
        <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-fg-muted">The database service is currently unavailable, so this page could not load correctly. Try again now. If the problem continues, restart your browser and reopen the dashboard. We will also retry automatically every 60 seconds.</p>
