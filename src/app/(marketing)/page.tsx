...
export default async function LandingPage() {
  ...
  return (
    <div className="relative bg-[#070a0f]" style={{ backgroundImage: "linear-gradient(rgba(7,10,15,.68), rgba(7,10,15,.86)), url('/public-minecraft-ambience.png')", backgroundSize: 'cover', backgroundPosition: 'center top', backgroundAttachment: 'fixed' }}><div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(34,211,238,.2),transparent_32%),radial-gradient(circle_at_82%_22%,rgba(245,158,11,.14),transparent_28%)]" /><div className="pointer-events-none absolute inset-0 bg-[#070a0f]/20 backdrop-blur-[2px]" />
      <section className="relative mx-auto grid max-w-[95rem] gap-12 overflow-hidden px-4 pb-20 pt-16 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-20 lg:pb-28 lg:pt-24"><div className="pointer-events-none absolute -right-20 top-10 size-80 rounded-full bg-primary-500/10 blur-3xl" /><div className="pointer-events-none absolute right-24 top-20 hidden size-48 rotate-12 rounded-3xl border border-primary-500/20 lg:block" /><div className="pointer-events-none absolute right-16 top-32 hidden size-48 rotate-12 rounded-3xl border border-success/20 lg:block" />
        <div className="relative z-10 max-w-2xl"><div className="mb-5 inline-flex items-center gap-2 rounded-full border border-primary-500/25 bg-panel-bg/70 px-3 py-1.5 font-mono text-[10px] uppercase tracking-[.18em] text-primary-500 backdrop-blur"><span className="size-1.5 rounded-full bg-success shadow-[0_0_10px_rgba(34,197,94,.8)]" /> Season board online</div>
