...
const capabilities = [
  ...
  { icon: Server, title: "Game infrastructure", text: "Provision queues, lobbies, servers, and snapshots from one place." },
  { icon: Gauge, title: "Live operations", text: "See health, activity, and competitive signals without leaving your command center." },
