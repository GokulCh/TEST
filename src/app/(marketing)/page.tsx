...
export default async function LandingPage() {
  ...
  return (
    <div className="relative overflow-x-clip bg-[#070a0f]"><div className="pointer-events-none absolute inset-0 -z-0 scale-105 bg-cover bg-center opacity-60 blur-[2px]" style={{ backgroundImage: "linear-gradient(rgba(7,10,15,.58), rgba(7,10,15,.78)), url('/public-minecraft-ambience.png')", backgroundAttachment: 'fixed' }} /><div className="relative z-10"><div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(34,211,238,.2),transparent_32%),radial-gradient(circle_at_82%_22%,rgba(245,158,11,.14),transparent_28%)]" />
      <section className="relative mx-auto grid max-w-[95rem] gap-12 px-4 pb-20 pt-16 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-20 lg:pb-28 lg:pt-24"><div className="pointer-events-none absolute -right-20 top-10 size-80 rounded-full bg-primary-500/10 blur-3xl" /><div className="pointer-events-none absolute right-24 top-20 hidden size-48 rotate-12 rounded-3xl border border-primary-500/20 lg:block" /><div className="pointer-events-none absolute right-16 top-32 hidden size-48 rotate-12 rounded-3xl border border-success/20 lg:block" />
