...
export default async function LandingPage() {
  ...
  return (
    <div className="relative overflow-hidden bg-[#070a0f]" style={{ backgroundImage: "linear-gradient(rgba(7,10,15,.9), rgba(7,10,15,.98)), url('/public-minecraft-ambience.png')", backgroundSize: 'cover', backgroundPosition: 'center top', backgroundAttachment: 'fixed' }}><div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(34,211,238,.12),transparent_28%),radial-gradient(circle_at_82%_22%,rgba(245,158,11,.08),transparent_24%)]" />
