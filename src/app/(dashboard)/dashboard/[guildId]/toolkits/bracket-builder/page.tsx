...
export default function Page() {
	...
	const [tournament, setTournament] = useState({
		type: "SINGLE_ELIMINATION", // SINGLE_ELIMINATION, DOUBLE_ELIMINATION
		slots: 0,
		autoSeeding: false,
		roundsCount: 0,
	});

	const handleInputChange = (field: keyof typeof tournament, value: any) => {
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
								<div className="space-y-1.5">
									...
									<select
										...
										className="w-full h-9 px-2 bg-bg-canvas/40 border border-border-subtle rounded-lg text-fg-default focus:outline-none"
									>
