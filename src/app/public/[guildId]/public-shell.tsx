...
export function SectionHeading({ eyebrow, title, description }: { eyebrow: string; title: string; description: string }) { return <div className="public-enter mx-auto mb-10 max-w-4xl text-center"><p className="mb-3 font-mono text-[11px] font-bold tracking-[0.24em] text-cyan-300">// {eyebrow}</p><h1 className="text-4xl font-black tracking-[-0.04em] sm:text-5xl">{title}</h1><p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-white/55">{description}</p></div> }
