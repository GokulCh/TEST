...
export function PublicShell({ guildId, children }: { guildId: string; children: React.ReactNode }) {
  ...
  return <ThemeScope><div className="relative flex min-h-screen flex-col overflow-x-clip bg-[#070a0f] text-white selection:bg-cyan-400/30 [scrollbar-gutter:stable]" style={{ backgroundImage: "linear-gradient(rgba(7,10,15,.72), rgba(7,10,15,.88)), url('/public-minecraft-ambience.png')", backgroundSize: 'cover', backgroundAttachment: 'fixed' }}><div className="pointer-events-none fixed inset-0 opacity-50 [background-image:linear-gradient(rgba(255,255,255,.035)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.035)_1px,transparent_1px)] [background-size:48px_48px]" /><div className="pointer-events-none fixed inset-0 bg-[#070a0f]/20 backdrop-blur-[2px]" /><div className="pointer-events-none fixed -left-32 top-40 size-96 rounded-full bg-cyan-400/[0.05] blur-3xl" /><div className="pointer-events-none fixed -right-40 bottom-20 size-[28rem] rounded-full bg-amber-300/[0.04] blur-3xl" />
