          ...
          <div className="flex items-center justify-between border-t border-white/[0.08] px-5 py-4">
            <div className="flex items-center gap-2">
              <button
                ...
                disabled={page === 1}
                className="flex items-center gap-1 rounded-lg border border-white/[0.08] bg-white/[0.025] px-3 py-1.5 text-xs font-semibold text-white/70 transition-colors hover:bg-white/[0.05] disabled:opacity-50"
              >
                <ChevronsLeft className="size-3.5" /> Back 5
              </button>
              <button
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs text-white/45">Page</span>
              <input
                type="number"
                value={page}
                onChange={(e) => {
                  const val = parseInt(e.target.value);
                  if (!isNaN(val)) setPage(Math.min(totalPages, Math.max(1, val)));
                }}
                className="w-12 rounded-lg border border-white/[0.09] bg-white/[0.025] py-1 text-center text-xs text-white outline-none focus:border-cyan-300/40"
              />
              <span className="text-xs text-white/45">of {totalPages}</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1 rounded-lg border border-white/[0.08] bg-white/[0.025] px-3 py-1.5 text-xs font-semibold text-white/70 transition-colors hover:bg-white/[0.05] disabled:opacity-50"
              >
                Next 5 <ChevronsRight className="size-3.5" />
              </button>
            </div>
          </div>
        </PublicCard>
