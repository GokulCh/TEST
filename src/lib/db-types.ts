...
export interface CommandRequirements {
  roles: Record<string, CommandRequirementEntry> | null;
  channels: Record<string, CommandRequirementEntry> | null;
  categories: Record<string, CommandRequirementEntry> | null;
  threads: Record<string, CommandRequirementEntry> | null;
}

export interface CommandRequirementEntry {
  key: string;
  optional: boolean;
...
export type NameHistoryKind = "username" | "nickname";

export interface PlayerNameHistory {
  id: DBID;
  player_config_id: DBID;
  guild_id: DBID;
  player_id: DBID;
...
export interface NameHistoryCountsPayload {
  total: number;
